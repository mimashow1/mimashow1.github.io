...
<html>
  ...
  <body>
    ...
    <div class="body" id="city">
      <h1>London</h1>
      <div id="city-images">
        <img id="see" src="img/lond_city.jpg" alt="">
        <img src="img/lond_hotel1.jpg" alt="">
        <img src="img/lond_hotel2.jpg" alt="">
      </div>
      ...
      <div id="city-about">
        <h3>About London</h3>
        <p>The City of London, the capital of United Kingdom is a year-round
        tourist destination. London is the largest city in Europe and located
        astride the famous river of Thames. This is the home for most of the
        international organizations and the city is headed by the Lord Mayor of
        London. The city of London has its own police force, call City of London
        police.

        London is considered as both business and tourist destination and visited
        by millions of people annually. The Heathrow Airport, London considered as
        the busiest airport in the world. City of London provides many attractions
        for visitors. You can visit London museums, see Royal palaces and activities,
        relax on London parks and many more places for bed and dine. London is
        considered an expensive city in the world and even though its home for
        many foreign migrants, still keeping its traditional heritage and surrounding.

        The city of London is consists of different sub areas and they have separate
        postal code for each. Many events taken place in London annually and city
        provides a good transport system also. London underground is convenient
        and cheap way of traveling. London is the selected venue for year 2012
        Olympics and infrastructure work already started for that.</p>
      ...
      <iframe id="map" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d535026.0565239048!2d-0.46605215142712914!3d51.469573777052425!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47d8a00baf21de75%3A0x52963a5addd52a99!2z0JvQvtC90LTQvtC9LCDQktC10LvQuNC60L7QsdGA0LjRgtCw0L3QuNGP!5e0!3m2!1sru!2slv!4v1517156271882" frameborder="0" style="border:0" allowfullscreen></iframe>
